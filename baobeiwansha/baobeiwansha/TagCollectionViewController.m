    ...
    if(self.index == 0){
        ...
        @{@"sectionTitle":@"热门",
          @"sectionItems":@[
                  ...
                  @{@"label":@"春节",@"image":@"head3.jpg"},
                  @{@"label":@"下雪了",@"image":@"snow"},
                  @{@"label":@"好奇心",@"image":@"curios"},
                  @{@"label":@"秩序与规则",@"image":@"law"},
                  @{@"label":@"沟通能力",@"image":@"talk"},
                  @{@"label":@"饭后半小时",@"image":@"head3.jpg"},
        ...
        @{@"sectionTitle":@"场景",
          @"sectionItems":@[
                  ...
                  @{@"label":@"起床",@"image":@"head3.jpg"},
                  @{@"label":@"周末",@"image":@"head3.jpg"},
                  @{@"label":@"饭后半小时",@"image":@"head3.jpg"},
                  @{@"label":@"春天",@"image":@"flower"},
                  @{@"label":@"落叶",@"image":@"leaf"},
                  @{@"label":@"公园里",@"image":@"head3.jpg"},
                  @{@"label":@"小区里",@"image":@"community"},
                  @{@"label":@"和小朋友玩",@"image":@"head3.jpg"},
                  @{@"label":@"月亮",@"image":@"night"},
                  @{@"label":@"下雨了",@"image":@"rain"},
        ...
        @{@"sectionTitle":@"主题",
          @"sectionItems":@[
                  ...
                  @{@"label":@"准时睡觉",@"image":@"head3.jpg"},
                  @{@"label":@"起床气",@"image":@"head3.jpg"},
